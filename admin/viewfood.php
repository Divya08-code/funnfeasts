  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">view food</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <td>
        <a href="showfood.php?id=<?php echo $result['id']?>" class="btn btn-info">Show</a>
        <a href="editfood.php?id=<?php echo $result['id']?>" class="btn btn-primary">edit</a>
        <a href="deletefood.php?id=<?php echo $result['id']?>" class="btn btn-danger">delete</a>
                     </td>
                    </tr>
                    <?php
